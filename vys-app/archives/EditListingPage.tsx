...
export default function EditListingPage({
  ...
  const captured = imgs[0]; // first image
...
<div className="w-full max-w-md flex flex-col items-center gap-4 mt-8">
  ...
  {/* {captured ? (
          <div className="w-full max-w-md aspect-square bg-white rounded-md mb-6 overflow-hidden">
            <img src={captured} alt="Captured" className="object-cover w-full h-full" />
          </div>
        ) : (
          <div className="w-full max-w-md aspect-square bg-white rounded-md flex items-center justify-center mb-6">
        ...
        <div className="flex gap-3 w-max">
            ...
            <div className="w-full max-w-md space-y-2 mb-4">
                ...
                <div className="flex justify-center pt-4">
                    ...
                    <button type="submit" className="bg-[#052958] hover:bg-indigo-950 text-[#A1C9FF] outline font-semibold py-2 px-6 rounded-full transition duration-200">Submit</button>
                </div>
            </div>
        </main>
    </form>
